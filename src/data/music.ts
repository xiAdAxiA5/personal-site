...
export const albums: Album[] = [
  ...
  { id: 'single-01', title: '香格里拉', artist: '魏如萱', cover: '', genre: 'Pop', type: 'single', tracks: [{ title: '香格里拉', duration: '', description: '暂无版权' }] },
  { id: 'single-02', title: '新手', artist: '裘德', cover: '', genre: 'Pop', type: 'single', tracks: [{ title: '新手', duration: '', description: '暂无版权' }] },
  { id: 'single-03', title: 'Simon', artist: '丁世光', cover: '', genre: 'Pop', type: 'single', tracks: [{ title: 'Simon', duration: '', description: '暂无版权' }] },
  { id: 'single-04', title: '大年夜怪奇物语', artist: '裘德', cover: '', genre: 'Pop', type: 'single', tracks: [{ title: '大年夜怪奇物语', duration: '', description: '暂无版权' }] },
  { id: 'single-05', title: 'Let Me Go', artist: '关浩德', cover: '', genre: 'Pop', type: 'single', tracks: [{ title: 'Let Me Go', duration: '', description: '暂无版权' }] },
  { id: 'single-06', title: 'Simon (Live)', artist: '裘德', cover: '', genre: 'Pop', type: 'single', tracks: [{ title: 'Simon (Live)', duration: '', description: '暂无版权' }] },
  { id: 'single-07', title: '拆穿 (Live)', artist: '周菲戈', cover: '', genre: 'Pop', type: 'single', tracks: [{ title: '拆穿 (Live)', duration: '', description: '暂无版权' }] },
  ...
  { id: 'single-15', title: '那个女孩', artist: '陶喆/卢广仲', cover: '', genre: 'Pop', type: 'single', tracks: [{ title: '那个女孩', duration: '', description: '暂无版权' }] },
  { id: 'single-16', title: '几分之几', artist: '卢广仲', cover: '', genre: 'Pop', type: 'single', tracks: [{ title: '几分之几', duration: '', description: '暂无版权' }] },
  { id: 'single-17', title: '留香', artist: '许嵩', cover: '', genre: 'Pop', type: 'single', tracks: [{ title: '留香', duration: '', description: '暂无版权' }] },
  { id: 'single-18', title: '飞鸽', artist: '周菲戈', cover: '', genre: 'Pop', type: 'single', tracks: [{ title: '飞鸽', duration: '', description: '暂无版权' }] },
  { id: 'single-19', title: '半空', artist: '陈之', cover: '', genre: 'Pop', type: 'single', tracks: [{ title: '半空', duration: '', description: '暂无版权' }] },
  { id: 'single-20', title: '颜色', artist: 'Gareth.T', cover: '', genre: 'Pop', type: 'single', tracks: [{ title: '颜色', duration: '', description: '暂无版权' }] },
  { id: 'single-21', title: '用背脊唱情歌', artist: 'Gareth.T', cover: '', genre: 'Pop', type: 'single', tracks: [{ title: '用背脊唱情歌', duration: '', description: '暂无版权' }] },
  { id: 'single-22', title: '国际孤独等级', artist: 'Gareth.T', cover: '', genre: 'Pop', type: 'single', tracks: [{ title: '国际孤独等级', duration: '', description: '暂无版权' }] },
  { id: 'single-23', title: '关于爱的定义', artist: '方大同', cover: '', genre: 'Pop', type: 'single', tracks: [{ title: '关于爱的定义', duration: '', description: '暂无版权' }] },
  { id: 'single-24', title: '低空鸟人', artist: '孟慧圆', cover: '', genre: 'Pop', type: 'single', tracks: [{ title: '低空鸟人', duration: '', description: '暂无版权' }] },
  {
    id: 'jude-silver',
    title: '离开银色荒原',
    artist: '裘德',
